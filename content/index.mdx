...
**HikingMyDesk** is an awesome [GatsbyJS](http://gatsbyjs.org/) documentation :book:
...
## What HikingMyDesk offers? :fire:

<Tip>HikingMyDesk is open source and free -- forever!</Tip>
...
- custom CLI helping to initialize and develop HikingMyDesk apps
