...
export type FileFieldsEnum = 
  ...
  | 'childrenMdx___frontmatter___showToc'
  | 'childrenMdx___frontmatter___tocDepth'
  | 'childrenMdx___frontmatter___editable'
  | 'childrenMdx___frontmatter___showMetadata'
  | 'childrenMdx___frontmatter___showPreviousNext'
